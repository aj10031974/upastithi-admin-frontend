            ...
            <Dropdown alignRight as="li" className="nav-item">
              <Dropdown.Toggle as="a" className="nav-link cursor-pointer no-caret">
                <div className="navbar-profile">
                  ...
                  <p className="mb-0 d-none d-sm-block navbar-profile-name"><Trans>{localStorage.getItem("Name")}</Trans><div style={{fontSize:"0.85rem"}}>{localStorage.getItem("setAuthority") == 1 ? "(Admin)":localStorage.getItem("setAuthority") == 2 ? "(Authority)":localStorage.getItem("setAuthority") == 3 ? "(Institute)":"TBD"}</div></p>
              ...
              <Dropdown.Menu className="navbar-dropdown preview-list navbar-profile-dropdown-menu">
                ...
                <Dropdown.Divider />
                <Dropdown.Item href="!#" onClick={evt =>this.logout(evt)}  className="preview-item">
                  <div className="preview-thumbnail">
                    <div className="preview-icon bg-secondary rounded-circle">
