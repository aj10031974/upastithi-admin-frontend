...
export default function EnhancedTable({rows}) {
  ...
  const [orderBy, setOrderBy] = React.useState('collegename');
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left" id={labelId} padding="30px">{row.id}</TableCell>
                      <TableCell>
                        {row.name}
                      </TableCell>
                      ...
                      <TableCell align="right">{row.totalLectures}</TableCell>
